========================================================================
    ACTIVE TEMPLATE LIBRARY : GMBAudioCOM Project Overview
========================================================================

AppWizard has created this GMBAudioCOM project for you to use as the starting point for
...
GMBAudioCOM.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (GMBAudioCOM.h)
        GUID definitions                                (GMBAudioCOM_i.c)
        A type library                                  (GMBAudioCOM.tlb)
        Marshaling code                                 (GMBAudioCOM_p.c and dlldata.c)

GMBAudioCOM.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in GMBAudioCOM.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named GMBAudioCOM.pch and a precompiled types file named StdAfx.obj.
...
GMBAudioCOMps.vcxproj
	...
	dlldata.c, GMBAudioCOM_i.c and GMBAudioCOM_p.c which are required
	to build the proxy/stub DLL.

GMBAudioCOMps.vcxproj.filters
